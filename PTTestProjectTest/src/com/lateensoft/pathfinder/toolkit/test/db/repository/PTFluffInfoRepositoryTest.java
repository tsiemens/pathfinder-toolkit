...
public class PTFluffInfoRepositoryTest extends PTBaseRepositoryTest {	
	private PTFluffInfo m_fluff;
	private PTFluffInfoRepository m_repo;
	
	@Override
	public void setUp() {
		super.setUp();
		m_repo = new PTFluffInfoRepository();
	...
	public void testQuery() {
		PTFluffInfo queried = m_repo.query(m_characterId);
	...
	public void testUpdate() {
		PTFluffInfo toUpdate = new PTFluffInfo();
		...
		PTFluffInfo updated = m_repo.query(m_characterId);
