...
public class PTAbilitySetCalculator {
	...
	public PTAbilitySetCalculator() {
		this(new PTAbilitySet());
	}
	
	public PTAbilitySetCalculator(PTAbilitySet abilitySet) {
	...
	public int getScorePostRaceMod(int index) {
		PTAbility ability = m_abilitySet.getAbilityAtIndex(index);
	...
	public void setCalculatedAbilityScores(PTAbilitySet abilitySet) {
		for (int i = 0; i < abilitySet.size(); i++) {
			PTAbility calcAb = m_abilitySet.getAbilityAtIndex(i);
