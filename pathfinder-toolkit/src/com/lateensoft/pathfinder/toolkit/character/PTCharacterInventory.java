...
public class PTCharacterInventory implements Parcelable{
	...
	public PTCharacterInventory(Parcel in) {
	...
	public static final Parcelable.Creator<PTCharacterInventory> CREATOR = new Parcelable.Creator<PTCharacterInventory>() {
		public PTCharacterInventory createFromParcel(Parcel in) {
			return new PTCharacterInventory(in);
		}
		
		public PTCharacterInventory[] newArray(int size) {
			return new PTCharacterInventory[size];
		}
	};
}
