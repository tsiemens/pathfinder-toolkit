...
public class PartyMemberStatListAdapter extends ArrayAdapter<String>{
    Context m_context;
    int m_layoutResourceId;
    int[] m_statValues = null;
    String[] m_statNames = null;

    public PartyMemberStatListAdapter(Context context, int layoutResourceId, String[] statNames, int[] statValues) {
